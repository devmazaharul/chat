...
export default function InboxDesign() {
  ...
  return (
    ...
    <button className={`${state.trim().length>0?"text-gray-200 hover:bg-gray-600  text-2xl  rounded-full ":"text-gray-500"} p-2`} disabled={state.length==0?true:false}><IoIosSend className=' text-xl '/></button>
    </form>
  )
}
